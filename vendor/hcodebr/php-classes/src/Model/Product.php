...
class Product extends Model {
	...
	public function checkPhoto()
	{
		...
		return $this->setdesphoto($url);//estamos colocando dentro do objeto esta url e retornandoS
	}
	...
	{
		$this->checkPhoto();
		$values = parent::getValues();//puxa os dados do pai
	...
	public function setPhoto($file)
	{
		...
		switch ($extension) {
			case 'jpg':
			case 'jpeg':
			$image = imagecreatefromjpeg($file["tmp_name"]);//nome temporario do arquvo no servidor
