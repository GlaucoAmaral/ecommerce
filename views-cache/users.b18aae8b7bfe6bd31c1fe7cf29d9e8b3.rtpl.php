  		...
  		<div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tbody>
                  <?php $counter1=-1;  if( isset($users) && ( is_array($users) || $users instanceof Traversable ) && sizeof($users) ) foreach( $users as $key1 => $value1 ){ $counter1++; ?><!--nome da chave onde tem o array que quer que repita-->
                  <tr>
                    <td><?php echo htmlspecialchars( $value1["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td><!--ACESSANDO os valores do array-->
                  ...
                  <?php } ?><!--Aqui sabemos que terminou o loop-->
                </tbody>
              </table>
            </div>
            <!-- /.box-body -->
